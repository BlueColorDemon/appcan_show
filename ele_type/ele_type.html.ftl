...
<body class="um-vp c-wh" ontouchstart>
	<div class="umar-a c-wh2 ub uc-a1">
		<div class="ub ub-f1 uinnh2">
			<div class="reswoman ub-img umwh3"></div>
			<div class="ub ub-ac ub-f1 umar-l">服饰内衣促销专场</div>
		</div>
		<div class="ub ub-ac ub-pc c-orange uc-r1 uinn5">
			<div class="resright ub-img umwh1"></div>
		</div>
	</div>
...
function showGoods(){
	...
	var tmpl =	'<div class="ub ub-ac ubb b-gra uinn ">'
				+'	<div class="resshop ub-img umwh2" style="background-image: url(${'$'}{goods});"></div>'
