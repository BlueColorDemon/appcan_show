...
<div class="ub ub-ver uinn-a1">
	<div class="uba b-gra3 uc-a1 c-wh ub uinn-a7 ub-ac">
        <div class="ub-f1 uinn-a12">
            <div class="uinput uinn4">
                <input placeholder="邮箱" id="uid" type="text" class="">
            </div> 
        </div>
    </div>
	<div class="uba b-gra3 uc-a1 c-wh ub uinn-a7 ub-ac umar-at1">
        <div class="ub-f1 uinn-a12">
            <div class="uinput uinn4">
                <input placeholder="用户名" id="uid" type="text" class="">
            </div> 
        </div>
    </div>
	<div class="uba b-gra3 uc-a1 c-wh ub uinn-a7 ub-ac umar-at1">
        <div class="ub-f1 uinn-a12">
            <div class="uinput uinn4">
                <input placeholder="密码" id="uid" type="text" class="">
            </div> 
        </div>
    </div>
	<div class="uba b-gra3 uc-a1 c-wh ub uinn-a7 ub-ac umar-at1">
        <div class="ub-f1 uinn-a12">
            <div class="uinput uinn4">
                <input placeholder="确认密码" id="uid" type="text" class="">
            </div> 
        </div>
    </div>
	<div class="ub ub-ver">
